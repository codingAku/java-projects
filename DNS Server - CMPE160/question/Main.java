...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        tree.insertRecord("google.com", "3.3.3.60");
        tree.insertRecord("google.com", "3.3.3.70");
        ...
        printer.println(tree.removeRecord("google.com","3.3.3.3"));
        printer.println(tree.removeRecord("google.com","3.3.3.30"));
        printer.println(tree.removeRecord("google.com","3.3.3.40"));
        printer.println(tree.removeRecord("google.com","3.3.3.50"));
        printer.println(tree.removeRecord("google.com"));
        printer.println(tree.removeRecord("mail.google.com","4.4.4.4"));
        printer.println(tree.removeRecord("mail.google.com","4.4.4.6"));
        printer.println(tree.removeRecord("mail.google.com","4.4.4.5"));
        
        
        
        
        printer.println(tree.removeRecord("bbc.co.uk"));
        
        printer.println(tree.removeRecord("bbc.com.uk"));
        printer.println(tree.removeRecord("boun.edu.tr"));
        ...
        for (int j = 0; j <20; j++){
            ...
            x = new Client("x", tree);
            for (int i = 0; i < testSize; i++) {
                printer.println(x.sendRequest("site"+i+".com.tr"));
                printer.println(x.sendRequest("cmpe.boun.edu.tr"));
                printer.println(x.sendRequest("google.com"));
                printer.println(x.sendRequest("metu.edu.tr"));
                printer.println(x.sendRequest("developer.twitter.com"));
                printer.println(x.sendRequest("site1.com.tr"));
                printer.println(x.sendRequest("site2.com.tr"));
                printer.println(x.sendRequest("site3.com.tr"));
                printer.println(x.sendRequest("site4.com.tr"));
                printer.println(x.sendRequest("site5.com.tr"));
            }
        ...
        printer.println(Arrays.toString(x.getCacheList()));
        printer.println(tree.getAllRecords().toString());
        printer.println(tree.queryDomain("google.com"));
        printer.println(tree.queryDomain("google.com"));
